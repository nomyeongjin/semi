...
CREATE TABLE "CONTACT" (
	"CONTACT_NO"	NUMBER	NOT NULL CONSTRAINT "PK_CONTACT" PRIMARY KEY,
	"CONTACT_EMAIL"	NVARCHAR2(100)		NOT NULL,
	"CONTACT_NAME"	NVARCHAR2(50)		NOT NULL,
	"CONTACT_GENDER"	CHAR(1)	NOT NULL,
	"CONTACT_AGE"	NUMBER	NOT NULL,
	"CONTACT_TEL"	CHAR(11)		NULL,
	"CONTACT_TIME"	NVARCHAR2(50)	NOT NULL,
	"CONTACT_ADDRESS"	NVARCHAR2(200)	NOT NULL,
	"CONTACT_MARRY"	CHAR(1)	DEFAULT 'N'	NOT NULL,
	"CONTACT_JOB"	VARCHAR2(100)	NOT NULL,
	"MEMBER_NO" NUMBER NOT NULL 
);
...
ALTER TABLE "CONTACT" ADD CONSTRAINT "FK_CONTACT_TO_MEMBER" FOREIGN KEY (
	"MEMBER_NO"
)
REFERENCES "MEMBER" (
	"MEMBER_NO"
);
ALTER TABLE "CONTACT" ADD CONSTRAINT "FK_CONTACT_TO_ADOPT" FOREIGN KEY (
	"ADOPT_NO"
)
REFERENCES "ADOPT" (
	"ADOPT_NO"
...
ALTER TABLE "CONTACT" ADD(ADOPT_NO NUMBER);
...
SELECT THUMNAIL , ADOPT_NAME , ADOPT_AGE, ADOPT_TYPE , ADOPT_ADDRESS 
FROM "ADOPT"
WHERE MEMBER_NO =1;
